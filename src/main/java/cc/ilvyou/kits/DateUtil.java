...
public class DateUtil {
     ...
     * @return 数值
     */
    private static int getInteger(Date date,
                                  int dateType) {
     ...
     * @return 计算后日期
     */
    private static Date addInteger(Date date,
                                   int dateType,
                                   int amount) {
        Date myDate = null;
        if (date != null) {
    ...
    public static int getWeekOfYear(String date) {
        ...
        if (dateStyle != null) {
            Date myDate = StringToDate(date, dateStyle);
            weekOfYear = getWeekOfYear(myDate);
        }
        return weekOfYear;
    }
     ...
     * @return 相差天数
     */
    public static int compareDaysTo(Date date,
                                    Date otherDate) {
        date = DateUtil.StringToDate(DateUtil.getDate(date));
     ...
     * @return 相差天数
     */
    public static long compareSecondsTo(long date,
                                        long otherDate) {
        long result = (date - otherDate) / 1000;
        return result;
    }


    public static long compareSecondsTo(String dateStr1,
                                        String dateStr2,
                                        DateStyle style) {
        Date date1 = StringToDate(dateStr1, style);
        Date date2 = StringToDate(dateStr2, style);

        return compareSecondsTo(date1.getTime(), date2.getTime());
    }
    
    public static String revertTimeToString (long time){
        String result = "";
        long second = 1;
        long minutes = second * 60;
        long hours = minutes * 60;
        long hourDiff = time / hours;
        long minuteDiff = (time - hourDiff * hours) / minutes;
        long secondDiff = (time - hourDiff * hours - minuteDiff * minutes ) / second;
        if (hourDiff > 0) {
            result = hourDiff + "时" + minuteDiff + "分";
        } else if (minuteDiff > 0) {
            result = minuteDiff + "分" + secondDiff + "秒";
        } else {
            result = secondDiff + "秒";
        }
        return result;
    ...
    public static void main(String[] args) {
        System.out.println(DateUtil.revertTimeToString(60));
    }
